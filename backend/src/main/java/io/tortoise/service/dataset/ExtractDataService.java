...
import io.tortoise.base.mapper.DatasetTableMapper;
import io.tortoise.base.mapper.DatasetTableTaskMapper;
import io.tortoise.base.mapper.DatasourceMapper;
import io.tortoise.commons.constants.JobStatus;
import io.tortoise.commons.constants.ScheduleType;
import io.tortoise.commons.constants.UpdateType;
import io.tortoise.commons.utils.CommonBeanFactory;
import io.tortoise.commons.utils.DorisTableUtils;
import io.tortoise.commons.utils.HttpClientUtil;
import io.tortoise.commons.utils.LogUtil;
import io.tortoise.datasource.constants.DatasourceTypes;
import io.tortoise.datasource.dto.DorisConfigration;
import io.tortoise.datasource.dto.MysqlConfigration;
import io.tortoise.datasource.dto.SqlServerConfigration;
import io.tortoise.datasource.dto.TableFiled;
import io.tortoise.datasource.provider.DatasourceProvider;
import io.tortoise.datasource.provider.JdbcProvider;
...
public class ExtractDataService {
    ...
    private static String creatTableSql = "CREATE TABLE IF NOT EXISTS `TABLE_NAME`" +
            "Column_Fields" +
            "UNIQUE KEY(tortoise_uuid)\n" +
            "DISTRIBUTED BY HASH(tortoise_uuid) BUCKETS 10\n" +
    ...
    private void extractData(DatasetTable datasetTable, String extractType) throws Exception {
        ...
        if (jobStatus.getStatusDescription().equals("Finished")) {
            ...
            TortoiseException.throwException((jobStatus.getLoggingString()));
        }
    }
    ...
    private void generateJobFile(String extractType, DatasetTable datasetTable, String columnFeilds) throws Exception {
        ...
        String columns = columnFeilds + ",tortoise_uuid";
    ...
    private StepMeta udjc(List<DatasetTableField> datasetTableFields, boolean isExcel) {
        ...
        UserDefinedJavaClassMeta.FieldInfo fieldInfo = new UserDefinedJavaClassMeta.FieldInfo("tortoise_uuid", ValueMetaInterface.TYPE_STRING, -1, -1);
    ...
    private static String code = "import org.pentaho.di.core.row.ValueMetaInterface;\n" +
            ...
            "\n" +
            "  String md5 = md5(str);\n" +
            "  get(Fields.Out, \"tortoise_uuid\").setValue(r, md5);\n" +
            "\n" +
